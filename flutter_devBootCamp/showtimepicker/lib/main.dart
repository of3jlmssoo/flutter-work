                    ...
                    onPressed: () async {
                      final TimeOfDay? time = await showTimePicker(
                        ...
                        initialTime: selectedTime ??
                            TimeOfDay(
                                hour: 5,
                                minute: 15), // done: change the default value
                        // initialEntryMode: entryMode,
                        initialEntryMode:
                            TimePickerEntryMode.dial, // done: use dial mode
                        // orientation: orientation, // done: use the default value
                          ...
                          return Theme(
                            data: Theme.of(context).copyWith(
                              ...
                              materialTapTargetSize: MaterialTapTargetSize
                                  .padded, // done: always use padded
                            ),
                            child: Directionality(
                              // textDirection: textDirection,
                              textDirection:
                                  TextDirection.ltr, // done: always use ltr
                              child: MediaQuery(
                                data: MediaQuery.of(context).copyWith(
                                  alwaysUse24HourFormat:
                                      true, // done: always use 24 hour format
                                ),
                                child: child!,
                              ),
                            ),
